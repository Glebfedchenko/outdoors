          ...
          <div className="u-margin-bottom-big">
            <div className="col-1-of-2">
              ...
              <p className="paragraph">
                ...
                doloremque placeat aliquam temporibus totam esse ex odit error
                odio voluptate? Ipsam maiores, dolores incidunt doloribus nam
                molestiae voluptatum qui aliquam.
              </p>
              <h3 className="heading-tertiary u-margin-bottom-small">
